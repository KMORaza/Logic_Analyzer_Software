...
namespace LogicAnalyzerSim
{
    public partial class Form1 : Form
    {
        ...
        private TextBox eyeDiagramPanel;
        ...
        private void InitializeComponent()
        {
            ...
            eyeDiagramPanel = new TextBox
            {
                Name = "eyeDiagramPanel",
            ...
            this.Controls.AddRange(new Control[]
            {
                ...
                eyeDiagramLabel, eyeDiagramPanel,
        ...
        private void Timer_Tick(object sender, EventArgs e)
        {
            ...
            var eyeDiagramData = analyzer.GetEyeDiagramData(fftChannelBox.SelectedIndex);
            ...
            eyeDiagramPanel.Text = eyeDiagramData;
